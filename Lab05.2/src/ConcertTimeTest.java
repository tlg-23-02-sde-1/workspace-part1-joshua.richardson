...
//        Perth ---- Australia/Perth
        ZoneId zoneIdToronto = ZoneId.of("Canada/Eastern");
        ZoneId zoneIdPerth = ZoneId.of("Australia/Perth");

        ZonedDateTime torontoConcert = ZonedDateTime.of(2020,6,18,19,0,0,0,zoneIdToronto);
        ZonedDateTime perthTime = torontoConcert.withZoneSameInstant(zoneIdPerth);
