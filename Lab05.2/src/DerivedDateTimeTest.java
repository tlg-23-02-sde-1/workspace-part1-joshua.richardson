...
//    }
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate nYDBirthday = LocalDate.of(2023,1,1).plusWeeks(38);
        System.out.println(nYDBirthday);
    }
    ...
    public static void testEarlyRetirement() {
        LocalDate bDay = LocalDate.of(1987,5,25);
    ...
    public static void testElectionDay() {
        LocalDate electionDay = LocalDate.of(2024,11,1).with(TemporalAdjusters.nextOrSame(DayOfWeek.MONDAY)).plusDays(1);
    ...
    public static void testAnniversary() {
        ...
        System.out.println(party + " : " + party.getDayOfWeek()  );
    }
}